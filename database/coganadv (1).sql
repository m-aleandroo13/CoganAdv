...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Mar 2021 pada 06.46
...
(2000001, 1000001, 8000003, 'Rp. 14.000', 'https://shopee.co.id/-MILOLI-Stempel-Transparan-DIY-Stamp-Silicone-Stamp-Motif-F0008-i.273166831.5859617921'),
(2000002, 1000002, 8000003, 'Rp. 14.000', 'https://shopee.co.id/-MILOLI-Stempel-Transparan-DIY-Stamp-Silicone-Stamp-Motif-F0008-i.273166831.5859617921'),
(2000003, 1000001, 8000002, 'Rp. 14.000', 'https://shopee.co.id/-MILOLI-Stempel-Transparan-DIY-Stamp-Silicone-Stamp-Motif-F0008-i.273166831.5859617921'),
(2000004, 1000001, 8000002, 'Rp. 14.000', 'https://shopee.co.id/-MILOLI-Stempel-Transparan-DIY-Stamp-Silicone-Stamp-Motif-F0008-i.273166831.5859617921'),
(2000005, 1000003, 8000001, 'Rp. 1.000', 'https://shopee.co.id/-MILOLI-Stempel-Transparan-DIY-Stamp-Silicone-Stamp-Motif-F0008-i.273166831.5859617921');
...
ALTER TABLE `tb_cart_pj`
  ...
  ADD KEY `id_barang_fk_cpj` (`id_barang`),
  ADD KEY `id_supplier_fk_cpj` (`id_supplier`);
...
ALTER TABLE `tb_penjualan`
  ...
  ADD KEY `id_barang_fk_pj` (`id_barang`);
...
--
ALTER TABLE `tb_barang`
  MODIFY `id_barang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000005;

--
-- AUTO_INCREMENT untuk tabel `tb_barang_produk`
--
ALTER TABLE `tb_barang_produk`
  MODIFY `id_barang_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tb_barang_supplier`
--
ALTER TABLE `tb_barang_supplier`
  MODIFY `id_barang_supplier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2000006;

--
-- AUTO_INCREMENT untuk tabel `tb_cart_pb`
--
ALTER TABLE `tb_cart_pb`
  MODIFY `id_cart_pb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3000001;

--
-- AUTO_INCREMENT untuk tabel `tb_cart_pj`
--
ALTER TABLE `tb_cart_pj`
  MODIFY `id_cart_pj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4000001;
...
--
ALTER TABLE `tb_penjualan`
  MODIFY `id_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7000001;
...
--
ALTER TABLE `tb_supplier`
  MODIFY `id_supplier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8000008;
...
--
ALTER TABLE `tb_barang_produk`
  ADD CONSTRAINT `id_barang_fk_sp` FOREIGN KEY (`id_barang`) REFERENCES `tb_barang` (`id_barang`),
  ADD CONSTRAINT `id_produk_fk_sp` FOREIGN KEY (`id_produk`) REFERENCES `tb_produk` (`id_produk`);

--
-- Ketidakleluasaan untuk tabel `tb_barang_supplier`
--
ALTER TABLE `tb_barang_supplier`
  ADD CONSTRAINT `id_barang_fk_bs` FOREIGN KEY (`id_barang`) REFERENCES `tb_barang` (`id_barang`),
  ADD CONSTRAINT `id_supplier_fk` FOREIGN KEY (`id_supplier`) REFERENCES `tb_supplier` (`id_supplier`);

--
-- Ketidakleluasaan untuk tabel `tb_cart_pj`
--
ALTER TABLE `tb_cart_pj`
  ADD CONSTRAINT `id_barang_fk_cpj` FOREIGN KEY (`id_barang`) REFERENCES `tb_barang` (`id_barang`),
  ADD CONSTRAINT `id_supplier_fk_cpj` FOREIGN KEY (`id_supplier`) REFERENCES `tb_supplier` (`id_supplier`);
...
--
ALTER TABLE `tb_penjualan`
  ADD CONSTRAINT `id_barang_fk_pj` FOREIGN KEY (`id_barang`) REFERENCES `tb_barang` (`id_barang`);
COMMIT;
