        ...
        <div class="col">
            <div class="card shadow-lg border-0 rounded-lg mb-4">
                <div class="card-header">
                    <h3 class="text-center font-weight-light my-2">Edit Data Barang</h3>
                </div>
                <div class="card-body mb-4">
                    <form action="<?= base_url('barang/edit'); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control py-4" name="stok_barang" id="inputStockBarang" type="text" value="<?= $barang['stok_barang']; ?>" />
                        </div>
